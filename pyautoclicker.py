...
THEMES = {
    "Dark": {
        ...
        "fg": "#f3f4f6",
        "accent": "#3a82f7",
        "accent_active": "#2d64c4",
        "button_fg": "#ffffff",
        "disabled_fg": "#9ca3af",
        "tab_bg": "#29293a",
        "tab_fg": "#cbd5f5",
        "selected_tab_fg": "#f8fafc",
        "tree_bg": "#222230",
        "tree_alt_bg": "#1b1b27",
        "detail_fg": "#e5e7eb",
    },
...
class AdvancedAutoclicker:
    ...
    def apply_theme(self, theme_name: str) -> None:
        ...
        self.style.configure("Status.TLabel", background=bg, foreground=fg, font=("Segoe UI", 12, "bold"))
        self.style.configure("Detail.TLabel", background=bg, foreground=colors["detail_fg"], font=("Segoe UI", 9))
        ...
        self.style.map(
            ...
            foreground=[("selected", colors["selected_tab_fg"]), ("disabled", colors["disabled_fg"])],
        )
        self.style.configure(
            "Accent.TButton",
            background=accent,
        ...
        self.style.map(
            "Accent.TButton",
            background=[("active", colors["accent_active"]), ("disabled", colors["disabled_fg"])],
        ...
        self.position_tree.tag_configure("even", background=colors["tree_bg"])
        self.position_tree.tag_configure("odd", background=colors["tree_alt_bg"])
        self.refresh_positions_tree()
